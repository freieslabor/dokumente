...
\begin{enumerate}
  \item Der Verein trägt den Namen \colorbox{yellow}{Freies~Labor}~e.~V.
  \item Er hat seinen Sitz in \colorbox{yellow}{Hildesheim} und wird dort in das
  ...
  \item Der Verein setzt sich zum Zweck:
    \begin{itemize}
      ...
      \item Kriminalprävention zu leisten, insbesondere im Umgang mit digitaler
        ...
        \todo{Vielleicht lieber durch etwas anderes ersetzen/\\rausnehmen?}
    \end{itemize}
...
\begin{enumerate}
  ...
  \item Eine Mitgliederversammlung ist außerdem einzuberufen, wenn es das
    ...
    \colorbox{yellow}{10\%} der Vereinsmitglieder in Textform und unter Angabe 
  ...
  \item Die Mitgliederversammlung als das oberste beschlussfassende Vereinsorgan
    ...
    \begin{itemize}
      ...
      \item \colorbox{yellow}{Aufnahme von Darlehen} \todo{Darlehen, die die 
        Summe der monatlichen Mitgliedsbeiträge nicht übersteigen ohne 
        Mitgliederversammlung zulassen?}
  ...
  \item Jede satzungsmäßig einberufene Mitgliederversammlung wird als
    beschlussfähig anerkannt, sofern mindestens \colorbox{yellow}{25\%} der 
    ...
    Anzahl der erschienen Mitglieder beschlussfähig. Auf diesen Umstand muss in 
    der Einladung zur Mitgliederversammlung besonders hingewiesen werden. Jedes 
    ordentliche Mitglied hat eine Stimme. Fördermitglieder sind berechtigt, an 
    den Versammlungen ohne Stimmrecht teilzunehmen.
  ...
  \item Die Ausübung des Stimmrechts auf der Mitgliederversammlung ist nur 
    möglich, wenn bis zum Zeitpunkt der Inanspruchnahme des e.~g. Rechts alle
    offenen Mitgliedsbeiträge des entsprechenden Mitglieds beglichen wurden.
\end{enumerate}
...
\begin{enumerate}
  \item Der Vorstand besteht aus mindestens 3~Mitgliedern: der/dem
    ...
    Beisitzern. Er vertritt den Verein gerichtlich und außergerichtlich. Je zwei 
    Vorstandsmitglieder, ausgenommen die Beisitzerinnen/Beisitzer, sind 
  ...
  \item Dem Vorstand obliegt die Führung der laufenden Geschäfte des Vereins. Er
    ...
    \begin{itemize}
      ...
      \todo{Bestellen von GeschäftsführerIn nötig?}
    \end{itemize}
  ...
  \item Dringende Beschlüsse des Vorstands können auch in Textform oder
    fernmündlich im Umlauf gefasst werden. \colorbox{yellow}{Der Umlaufbeschluss 
    wird abgebrochen, sobald ein}\\\colorbox{yellow}{Vorstandsmitglied der 
    Dringlichkeit widerspricht.} Dringende Beschlüsse müssen auf der 
  ...
  \item \colorbox{yellow}{Der Vorstand soll sich an den Beschlüssen der 
  regelmäßigen Plenumssitzungen}\\\colorbox{yellow}{der Mitglieder orientieren.}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Bei Auflösung oder Aufhebung des Vereins, des Verlustes seiner
    ...
    das Vermögen des Vereins nach Erfüllung sämtlicher Verpflichtungen an eine
    durch die letzte Mitgliederversammlung bestimmte steuerbegünstigte
